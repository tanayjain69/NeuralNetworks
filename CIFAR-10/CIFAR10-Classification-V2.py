...
model = NeuralNetwork()
model.load_state_dict(torch.load("./CIFAR-10/CIFAR-10modelV2.pth", weights_only=True))
saved_accuracy=72.73

lossfn = nn.CrossEntropyLoss()
optimiser = optim.SGD(model.parameters(), lr=0.001, momentum=0.9)
lr_scheduler = optim.lr_scheduler.ExponentialLR(optimiser, gamma=0.9)
        ...
        if (epoch%2==1):
            ...
            with torch.inference_mode():
                ...
                if (accuracy>saved_accuracy): 
                    torch.save(model.state_dict(), "./CIFAR-10/CIFAR-10modelV2.pth")
