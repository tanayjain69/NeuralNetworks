...
model.load_state_dict(torch.load('./MNIST_digit_recognition/mnistV2.pth', weights_only=True))
saved_accuracy = 99.26
model.to('xpu')
loss_fn.to('xpu')
    ...
    for epoch in range(epochs):
        ...
        if (epoch%3==2):
            ...
            if (accuracy>saved_accuracy):
                ...
                torch.save(model.state_dict(), './MNIST_digit_recognition/mnistV2.pth')
